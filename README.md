...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-control-panel-backups-api?sort=semver)](https://github.com/liberusoftware/module-control-panel-backups-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-control-panel-backups-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-control-panel-backups-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-control-panel-backups-api
```
...
<a href="https://github.com/liberusoftware/module-control-panel-backups-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-control-panel-backups-api" alt="Contributors to liberusoftware/module-control-panel-backups-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-control-panel-backups-api/graphs/contributors).
